      ...
      <Box sx={{ flexGrow: 0 }}>
        <Tooltip title="Open settings">
          <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
            <Avatar alt="Avatar" src={localAvatar} />
          </IconButton>
        </Tooltip>
        <Menu
          sx={{ mt: '45px' }}
        ...
        >
          <MenuItem component={ReactLink} to={"/dashboard"}>
            <Typography textAlign="center">Dashboard</Typography>
          </MenuItem>
          <MenuItem component={ReactLink} to={"/settings"}>
            <Typography textAlign="center">Settings</Typography>
          </MenuItem>
          <MenuItem component={ReactLink} to={"/add"}>
            <Typography textAlign="center">Host Now</Typography>
          </MenuItem>
